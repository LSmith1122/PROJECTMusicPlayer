...
class AudioPlayListFragment : Fragment() {
    ...
    companion object {
        fun newInstance() = AudioPlayListFragment()
    }

    private val viewModel: AudioPlayListViewModel by viewModels()
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_audio_play_list, container, false)
    }
}
